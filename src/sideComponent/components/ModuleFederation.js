...
export default ({ config, setConfig, trigger, setTrigger }) => {
  ...
  const [remoteConfigUrl, setRemoteConfigUrl] = useState(
    "https://pod.lbdserver.org/jeroen/public/remoteConfig.json"
  );
  const [options, setOptions] = useState(["https://pod.lbdserver.org/jeroen/public/remoteConfig.json", "https://pod.lbdserver.org/jeroen/public/remoteConfig1.json"])
